...
public sealed class DisableInventoryEffect : ExpansionDisableBase
{
    public DisableInventoryEffect() : base(
        ...
        [
            ...
            "open_director",
            "ui_open_director",
            "ui_open_director_new_quest_details",
            "ui_open_director_destinations",
            "ui_open_director_map",
            "ui_open_director_quests",
            "ui_open_director_roster",
            "ui_open_director_seasons",
            "quests",
            "quest_log",
            "open_quests",
            "ui_open_quests",
            ...
            "open_clan",
            "ui_open_clan",
            "ui_open_start_menu_clans",
            "ui_open_start_menu_collections",
            "season",
            "open_season",
            "ui_open_season",
            "store",
            ...
            "open_journey",
            "ui_open_journey",
            "ui_open_start_menu_journey",
            "loadouts",
            "open_loadouts",
            "ui_open_loadouts",
            "ui_open_start_menu_character",
            "ui_open_start_menu_inventory",
            "ui_open_start_menu_settings",
            "ghost",
            "open_ghost",
            "nav_mode",
            "game_menu",
